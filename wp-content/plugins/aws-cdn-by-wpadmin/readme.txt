...
1. [Download the plugin zip file](https://downloads.wordpress.org/plugin/aws-cdn-by-wpadmin.1.5.8.zip) and save it to your computer.
...
V.1.5.7
Added support for Woocommerce images

V.1.5.6
Added support for WPML

V.1.5.5
Fixed jQuery issue on the plugin admin page
